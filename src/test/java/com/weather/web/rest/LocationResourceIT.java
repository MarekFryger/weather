...
import com.weather.service.mapper.LocationMapper;
...
class LocationResourceIT {
    ...
    void putExistingLocation() throws Exception {
        ...
        updatedLocation.name(UPDATED_NAME).country(UPDATED_COUNTRY).lat(UPDATED_LAT).lon(UPDATED_LON).timeZone(UPDATED_TIME_ZONE);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.name(UPDATED_NAME).lat(UPDATED_LAT).lon(UPDATED_LON);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.name(UPDATED_NAME).country(UPDATED_COUNTRY).lat(UPDATED_LAT).lon(UPDATED_LON).timeZone(UPDATED_TIME_ZONE);
